...
// Multi Modal
// Multi-modal tutor (text + voice + image) with adaptive difficulty
...
export default function GapMultiModal() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Multi-modal tutor (text + voice + image) with adaptive difficulty</p>
