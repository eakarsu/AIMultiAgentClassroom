...
// Real Time
// Real-time misconception detection auto-adapting lesson path
...
export default function GapRealTime() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Real-time misconception detection auto-adapting lesson path</p>
