...
// Personalized
// Personalized learning paths by strength/weakness analysis
...
export default function GapPersonalized() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Personalized learning paths by strength/weakness analysis</p>
