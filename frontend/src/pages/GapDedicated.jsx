...
// Dedicated
// Dedicated teacher dashboard (limited surface)

export default function GapDedicated() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-dedicated', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Dedicated</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Dedicated teacher dashboard (limited surface)</p>
