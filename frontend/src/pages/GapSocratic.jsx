...
// Socratic
// Socratic dialogue agent guiding via questioning

export default function GapSocratic() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-socratic', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Socratic</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Socratic dialogue agent guiding via questioning</p>
